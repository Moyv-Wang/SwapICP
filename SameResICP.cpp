...
int main()
{
    ...
    downsampledCloud1 = DownSampling(cloud1, 0.01f);
    cout << "目标点云原始大小: " << cloud1->size() << ", 降采样后点云大小: " << downsampledCloud1->size() << std::endl;
    downsampledCloud2 = DownSampling(cloud2, 0.011f);
    cout << "源点云原始大小: " << cloud2->size() << ", 降采样后点云大小: " << downsampledCloud2->size() << std::endl;
    //用cloud1建立kd-tree
